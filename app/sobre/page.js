        ...
        <main className="w-full">
            ...
            <section className="flex items-center justify-center w-full flex-col">
                ...
                <article className="my-12 flex items-center justify-center w-full flex-col">
                    <p className="text-sm lg:text-base 2xl:text-lg w-3/5 md:w-4/5 2xl:w-3/4 text-justify mb-4">
                    ...
                    <p className="text-sm lg:text-base 2xl:text-lg w-3/5 md:w-4/5 2xl:w-3/4 text-justify">
